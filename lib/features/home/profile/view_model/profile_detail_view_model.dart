...
class ProfileDetailViewModel extends ChangeNotifier {
  ...
  ProfileDetailViewModel() {
    ...
    profile = ProfileDetailModel(
      ...
      clubName: 'GDSC',
      tags: ['BE', '직무직무', '경력'],
      intro: '안녕하세요! 저는 코고 개발자 김지은입니다.',
      description1: '오늘도 아침엔 입에 빵을 물고 똑같이 하루를 시작하고 온종일 한 손엔 아이스 아메리카노피곤해 죽겠네',
      description2: '오늘도 아침엔 입에 빵을 물고 똑같이 하루를 시작하고 온종일 한 손엔 아이스 아메리카노피곤해 죽겠네',
    );
  }
